...
### There is an option to create testcomponents that returns null, so we get access to all methods and variables (extra 1)

### react-hooks functionality to test hooks, rerendering also
